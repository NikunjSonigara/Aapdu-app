    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // buildAbout(user),
          // const SizedBox(height: 24),
          Center(child: Text("Team Details", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500),)),
        ...
        child: Row(
          children: [
            ...
            Container(
                ...
                child: CircleAvatar(
                  radius: 30,
                  backgroundImage: NetworkImage("https://images.app.goo.gl/f1m9tXorJtjdhCFy6"),
                  child: Align(
